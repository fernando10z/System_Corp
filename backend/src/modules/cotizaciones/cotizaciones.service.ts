...
export class CotizacionesService {
  ...
  listar(u: JwtPayload, otId: string) {
    return this.repo.listar(this.ctx(u), otId);
  }
  cargar(u: JwtPayload, otId: string, d: CargarCotizacionDto) {
    return this.repo.cargar(this.ctx(u), otId, d);
  }
  invalidar(u: JwtPayload, id: string, motivo: string) {
    return this.repo.invalidar(this.ctx(u), id, motivo);
  }
}
