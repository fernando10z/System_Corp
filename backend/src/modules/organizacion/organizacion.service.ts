...
export class OrganizacionService {
  ...
  arbol(u: JwtPayload) {
    return this.repo.arbol(this.ctx(u));
  }
  crearSucursal(u: JwtPayload, c: string, n: string, d?: string) {
    return this.repo.crearSucursal(this.ctx(u), c, n, d);
  }
  ...
  crearArea(u: JwtPayload, e: string, c: string, n: string) {
    return this.repo.crearArea(this.ctx(u), e, c, n);
  }
  listarAreas(u: JwtPayload, f: Record<string, unknown>) {
    return this.repo.listarAreas(this.ctx(u), f);
  }
}
