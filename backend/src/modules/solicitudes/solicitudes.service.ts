...
export class SolicitudesService {
  ...
  crear(u: JwtPayload, d: CrearSolicitudDto) {
    return this.repo.crear(this.ctx(u), d);
  }
  enviar(u: JwtPayload, id: string) {
    return this.repo.enviar(this.ctx(u), id);
  }
  tomarRevision(u: JwtPayload, id: string) {
    return this.repo.tomarRevision(this.ctx(u), id);
  }
  decidir(u: JwtPayload, id: string, d: DecidirSolicitudDto) {
    return this.repo.decidir(this.ctx(u), id, d);
  }
}
