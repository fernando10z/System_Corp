...
export class DashboardsService {
  ...
  coordinador(u: JwtPayload) { return this.repo.coordinador(this.ctx(u)); }
  solicitante(u: JwtPayload) { return this.repo.solicitante(this.ctx(u)); }
  kpis(u: JwtPayload, f: Record<string, unknown>) { return this.repo.kpis(this.ctx(u), f); }
}
