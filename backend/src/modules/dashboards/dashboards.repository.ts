...
export class DashboardsRepository {
  ...
  coordinador(ctx: SpContext) {
    return this.sp.callCtx<Record<string, unknown>>("app.fn_dashboard_coordinador", ctx, []);
  }
  solicitante(ctx: SpContext) {
    return this.sp.callCtx<Record<string, unknown>>("app.fn_dashboard_solicitante", ctx, []);
  }
